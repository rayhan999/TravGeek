...
import Logo from '../../../images/TravGeek-removebg-preview.png';
import './Footer.css';
                    ...
                    <Col md={12} lg={4}>
                        <div className="dk-footer-box-info">
                            <Link to="/" onClick={scrollHandler} className="footer-logo">
                                ...
                                <h3 className="text-center text-white mb-0">TravGeek</h3>
                            </Link>
                ...
                <Container>
                    <Row>
                        <Col md={6} className="order-2 order-md-1">
                            <span>Copyright © {new Date().getFullYear()}, All Rights Reserved TravGeek</span>
                        </Col>
