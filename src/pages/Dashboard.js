...
const Dashboard = ({ adminLoading }) => {
  ...
  if (!adminLoading && !isAdmin && (panel === "orderList" || panel === "addService" || panel === "makeAdmin" || panel === "manageServices")) {
  ...
  return (
    <main className="wrapper">
      <Sidebar show={showSidebar} setShowSidebar={setShowSidebar} adminLoading={adminLoading} />
      <div id="content">
