...
const ManageService = () => {
    ...
    const handleDeleteService = id => {
        ...
        swal({
            ...
            if (wantDelete) {
                ...
                axios.delete(`https://trav-geek-server.vercel.app/delete/${id}`)
                    .then(res => {
    ...
    return (
        editService._id ? <AddService editService={editService} setEditService={setEditService} /> :
                        ...
                        {services.map(service => {
                            return (
                                <tbody key={service._id} style={{ fontWeight: "500" }}>
                                    <tr>
                                        <td><img src={service.image} alt="image" className="img-fluid" width="100" /></td>
                                        <td>{service.title}</td>
