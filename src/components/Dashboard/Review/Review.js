    ...
    const handleDeleteReview = id => {
        swal({
            ...
            if (wantDelete) {
                ...
                axios.delete(`https://trav-geek-server.vercel.app/deleteReview/${id}`)
                    .then(res => {
    ...
    return (
        <section>
            <div className="testimonials mx-auto" style={{ borderRadius: "15px", maxWidth: '60rem' }}>
                ...
                <Card className="my-4 mx-auto d-flex justify-content-center align-items-center" style={{ maxWidth: "30rem" }}>
