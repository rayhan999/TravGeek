...
const OrderList = () => {
    ...
    useEffect(() => {
        axios.get(`https://immense-stream-47683.herokuapp.com/orders?email=${email}`)
            .then(res => {
                setOrders(res.data);
                setLoading(false);
            })
    ...
    const handleStatusChange = (id, status) => {
        ...
        axios.patch('https://immense-stream-47683.herokuapp.com/updateOrderStatus', modifiedStatus)
